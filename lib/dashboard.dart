...
import 'package:AgriView/default.dart';
import 'package:AgriView/farmerlist.dart';
import 'package:AgriView/models/County.dart';
import 'package:AgriView/placetomarketlist.dart';
import 'package:AgriView/wallet.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:AgriView/icons.dart';
...
class Dashboard extends StatefulWidget {
  ...
  const Dashboard({Key key, @required this.aggregatorAginID,@required this.firstName,@required this.lastName}): super(key: key);


  @override
  _DashboardState createState() => _DashboardState(aggregatorAginID,firstName,lastName);
}
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            CircleAvatar(
                              ...
                              child: IconButton(
                                icon: new Image.asset('assets/images/input.png'),
                                color: Colors.white,
                                onPressed: (){
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            CircleAvatar(
                              backgroundColor: Theme.of(context).primaryColorDark,
                              child: IconButton(
                                icon : new Image.asset('assets/images/market.png'),
                                color: Colors.white,
                                onPressed: (){
                        ...
                        child: Column(
                          children: <Widget>[
                            CircleAvatar(
                              backgroundColor:  Theme.of(context).primaryColorDark,
                              child: IconButton(
                                icon : new Image.asset('assets/images/produce.png'),
                                color: Colors.white,
                                onPressed: (){
                                  IncrementBloc bloc = BlocProvider.of<IncrementBloc>(context);
                                  bloc.incrementCounter.add(2);
                        ...
                        child: Column(
                          children: <Widget>[
                            CircleAvatar(
                              backgroundColor:  Theme.of(context).primaryColorDark,
                              child: IconButton(
                                icon : new Image.asset('assets/images/group_white.png'),
                                color: Colors.white,
                                onPressed: (){
                                  Navigator.pushNamed(context, '/newfarmergroup');
                                },
                              ),
                            ),
                            Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            CircleAvatar(
                              backgroundColor:  Theme.of(context).primaryColorDark,
                              child: IconButton(
                                icon : new Image.asset('assets/images/user_add.png'),
                                color: Colors.white,
                                onPressed: (){
                                  Navigator.pushNamed(context, '/newfarmer',arguments: {
